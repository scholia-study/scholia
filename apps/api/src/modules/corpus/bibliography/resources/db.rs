...
struct ResourceRow {
    ...
    src_original_year_circa: Option<bool>,
...
pub async fn list_resources(
    ...
    let rows = sqlx::query_as!(
        ...
        r#"SELECT r.id,
                  ...
                  s.original_year_circa AS "src_original_year_circa?",
        ...
        .map(|r| {
            let source = r.src_id.map(|sid| {
                ...
                SourceResponse {
                    ...
                    original_year_circa: r.src_original_year_circa.unwrap_or(false),
...
impl PeerResourceRow {
    fn split(self) -> (ResourceRow, PeerExtra) {
        ...
        let row = ResourceRow {
            ...
            src_original_year_circa: self.src_original_year_circa,
