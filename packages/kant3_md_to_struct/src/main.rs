...
use common::kant3::filenames;
use common::kant3::toc;
...
#[derive(Parser)]
#[command(
    about = "Parse curated Kant Kritik der Urteilskraft markdown into DB-ready JSON structures"
)]
struct Cli {
    ...
    #[arg(long, default_value = "assets/kant3/curated/md_reviewed")]
    reviewed_dir: String,

    /// Output file (- for stdout)
    #[arg(long, default_value = "assets/kant3/derived/md_to_struct/output.json")]
    output_file: String,
}
