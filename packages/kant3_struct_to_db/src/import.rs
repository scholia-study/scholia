...
pub async fn run(
    ...
    .await?;
        ...
        let about_text: &str = if source_book_id.is_some() {
            // Translation: English rendering of the German source.
            "This English translation of Kant's Kritik der Urteilskraft (Critique of the Power of \
         ...
         German text, which serves as the underlying source on Scholia."
            ...
            // Source-language book: the German Akademie-Ausgabe Band V text.
            "This German edition reproduces the text of Kant's Kritik der Urteilskraft as printed in the \
