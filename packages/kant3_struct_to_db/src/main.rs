...
#[derive(Parser)]
#[command(about = "Import structured Kant Kritik der Urteilskraft JSON into PostgreSQL")]
struct Cli {
    /// Input JSON file (output of kant3_md_to_struct / kant3_md_translation_to_struct)
