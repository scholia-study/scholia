...
const TOC: &[FlatEntry] = &[
    ...
    FlatEntry {
        aa_page: 28,
        depth: 2,
        label: "II. Wir sind im Besitze gewisser Erkenntnisse a priori, und selbst der gemeine Verstand ist niemals ohne solche",
    },
    FlatEntry {
        aa_page: 28,
        depth: 2,
        label: "III. Die Philosophie bedarf einer Wissenschaft, welche die Möglichkeit, die Principien und den Umfang aller Erkenntnisse a priori bestimme",
    },
    FlatEntry {
        aa_page: 33,
        depth: 2,
    ...
    FlatEntry {
        aa_page: 36,
        depth: 2,
        label: "V. In allen theoretischen Wissenschaften der Vernunft sind synthetische Urtheile a priori als Principien enthalten",
    },
    FlatEntry {
        aa_page: 39,
        depth: 2,
