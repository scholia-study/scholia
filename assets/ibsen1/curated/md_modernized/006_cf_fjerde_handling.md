...
@ {{{ 147 }}} Fyrstinne Helena *(vrir sine hender)*.
...
@stage (Eutherios og Myrrha går ut i bakgrunnen.)

@ {{{ 148 }}} Fyrstinne Helena *(synker ned i armstolen)*.
...
@ Cæsar Julian.
Aldri har jeg hørt slike jammerskrik; aldri har jeg sett så gapende sår, som dem vi trådte i, {{{ 154 }}} der vi vadet over de falne. Floden gjorde resten; de druknende kjempet innbyrdes til de veltet rundt og gikk tilbunns. De fleste av fyrstene falt levende i våre hender; Knodomar selv hadde søkt tilflukt i en rørklynge; en av hans ledsagere røpet ham, våre folk sendte en pileregn inn imot den skjulte, men uten å ramme. Da kom han frivillig frem og overgav seg.
...
@ Cæsar Julian.
Med deg, min elskede; og med mine kjære bøker, dem jeg her så sjelden har kunnet åpne, {{{ 159 }}} og dem jeg bare har turdet vie mine hvileløse netter.
...
@ {{{ 161 }}} Fyrstinne Helena *(klynger seg til ham)*.
*Er* jeg det, Julian?
...
@stage (Tribunen Decentius kommer fra bakgrunnen.)
...
@ {{{ 166 }}} Cæsar Julian *(etter et øyeblikks opphold)*.
...
Er du der, gamle faun? Frist meg ikke mer. *(til Decentius.)* Siden slaget ved Argentoratum taler han alltid til meg om seiers-vognen og det hvite forspann. *(til Sintula.)* Det ble Phaëtons ferd med {{{ 168 }}} de lybske solhester. Hvordan endte det? Har du glemt – har du glemt ditt hedenskap, hadde jeg nær sagt. – Om forlatelse, Decentius, at jeg sårer ditt fromme øre.
...
@stage (Hærføreren Severus, pretorianhøvdingen Florentius, samt flere krigsøverster og herrer ved Cæsars hoff kommer fra bakgrunnen).
...
@ {{{ 170 }}} Pretorianhøvdingen Florentius.
...
@ {{{ 171 }}} Pretorianhøvdingen Florentius.
...
@ {{{ 172 }}} Hærføreren Severus *(til Decentius)*.
...
@ {{{ 173 }}} Pretorianhøvdingen Florentius.
...
@ Cæsar Julian.
Var jeg ikke engang en visdomsvenn? Man sa det i det minste, både i Aten og i Efesos. Så svakt er det menneskelige sinn i medgang. Jeg var nær blitt visdommen utro. Keiseren {{{ 175 }}} har påminnet meg. Takk ham ydmykst, Decentius! Har du mer å melde?
...
{{{ 176 }}} Det er altså keiserens vilje at –? Godt, godt, edle Decentius; keiserens vilje skal bli etterkommet.
...
@stage (En hoffmann går ut i bakgrunnen; Cæsar Julian går hen til vinduet og leser papirene igjennom på ny.)
...
@ Cæsar Julian.
Jeg krever himlen til vidne på at jeg aldri –; ah, der er Sintula; så kan vi altså – *(til tribunen.)* Du går?
...
@ {{{ 181 }}} Cæsar Julian *(rekker ham et av papirene)*.
...
@stage (Stallmesteren Sintula går ut i bakgrunnen. Cæsar Julian vil ile ut til høyre, men møter i døren fyrstinne Helena omringet av slavinner. Hennes ansikt er vilt og forstyrret, hennes hår og klær i uorden.)
...
@ {{{ 184 }}} Fyrstinne Helena *(river seg løs)*.
...
@ {{{ 185 }}} Fyrstinne Helena *(ler sakte)*.
...
@ Fyrstinne Helena.
Drep presten også! Jeg vil ikke se ham etter dette, Du vet jo vår søte hemmelighet. {{{ 186 }}} O, du mine dagers lengsel, mine netters henrykkelse! Det var jo deg selv, – i din tjeners skikkelse – i bedekammeret; ja, ja, du var der; det var deg – i mørket, i luften, i virakens slørende skyer, hin natt, da den vordende Cæsar under mitt hjerte –
...
@stage (Slavinnene bærer fyrstinnen ut til høyre; i det samme kommer ridderen Sallust hurtig inn gjennom døren i bakgrunnen.)
...
@ Cæsar Julian.
Hvordan tyder du mine ord? Gå, gå; prøv, hva din kunst –; frels keiserens søster; keiseren {{{ 188 }}} ville føle seg utrøstelig ifall hans kjærlige omhu skulle dra noen ulykke etter seg. Ja, du vet vel, at hine frukter var en gave fra keiseren?
...
@ Tribunen Decentius.
Kall meg en ilsinnet mann, høye Cæsar; men min kjærlighet til keiseren og til hans sorgtrufne {{{ 190 }}} hus måtte i sannhet være ringere, enn den er, ifall den i en slik stund kunne gi rom for sindig overlegg.
...
@ {{{ 198 }}} Cæsar Julian *(likeledes i gråt)*.
...
@stage (De omstående løfter Julian høyt iveiret på et skjold og viser ham for mengden under lenge vedvarende bifallsrop.)
