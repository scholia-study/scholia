...
Hæren skal vedbli å rykke frem. Dog vil jeg denne aften, for en enn større sikkerhets {{{ 406 }}} skyld, anstille ofringer og se, hva tegnene måtte bekrefte.
...
@stage (Noen av livvakten driver spåmennene ut til venstre.)
...
@ Keiser Julian.
Ilferdig, som jeg var, kom jeg til å stenke noen vanndråper på din kappe. Da vek du {{{ 412 }}} hvast et skritt tilbake og rystet vannet av, som om kappen var blitt besudlet.
...
@ {{{ 415 }}} Keiser Julian *(stirrer ned i fjellkløften)*.
...
O, denne tapte visdoms skatt ville jeg bringe menneskene tilbake. Lik Dionysos fordum, kom {{{ 416 }}} jeg dem glad og ung i møte, med løv om pannen, med druers fylde i mine armer. Men de viser min gave fra seg, og jeg hånes og hates og bespottes av venner og av fiender.
...
@stage {{{ 422 }}} (En bakket skogegn med et vannløp mellom trærne. Oppe på høyden en liten landgård. Det er henimot solnedgang.)

@stage (Hæravdelinger drar fra venstre til høyre forbi nedenunder bakkene. Basilios fra Cæsaræa og hans søster Makrina, begge i eneboerklær, står nede ved veikanten og rekker vann og frukter til de utmattede soldater.)
...
@stage (En avdeling soldater kommer forbi; en ung mann i rekken faller av utmattelse om på veien.)
...
@stage (Keiser Julian med flere krigsøverster, ledsaget av livvaktsføreren Anatolos samt en vaktavdeling kommer fra venstre.)
...
@ Makrina.
Og jeg sier deg, keiser, at du ikke er annet enn en svøpe i Guds hånd, – en svøpe, som *må* slå oss for våre synders skyld. Ve oss, at dette skulle komme! Ve oss, at vi, splidaktig og kjærlighetsløst, vek av fra den rette vei!
...
@stage (Noen soldater har omringet Basilios og Makrina; andre iler gjennom tykningen opp mot huset.)
...
@stage (Husmesteren Eutherios, ledsaget av en mann i oppkiltrede klær kommer fra skipene.)

@ {{{ 438 }}} Husmesteren Eutherios.
...
@stage (En fakkel bringes; keiseren åpner brevet og leser.)
...
@ {{{ 442 }}} Perseren *(kaster seg ned på jorden)*.
...
@ Mystikeren Maximos.
Intet er viktigere enn dette. Du *må* høre meg!
...
@stage (Kristne soldater løper frem på sletten. Noen slår seg for brystet; andre sønderriver sine klær, alt under gråd og rop.)
...
@stage (Fromentinos og flere blant de omstående vil styrte inn på de kristne soldater. I det samme utbreder seg et sterkt lysende skinn; luer slår i været fra skipene.)
