...
@stage (Fyrst Julian kommer kort etter inn fra venstre. Han er iført en lang østerlandsk kledning; hele hans atferd er livfull og forråder en sterk indre spenning.)
...
@ Fyrst Julian.
Ei, hva kan ikke ryktet overdrive? – Men hva sier ryktet om meg forresten? Jeg har latt meg fortelle at det skal gå mange rykter om meg. Hvis jeg gadd feste lit til visses {{{ 107 }}} forsikring, så måtte jeg tro, det fantes få menn i riket, om hvem det tales så mye, som om meg.
...
| Frigjør deg, tømmende
| Bakki blod; –
| vugg deg på strømmende
| rytmers flod!
...
@stage (Bordlampene synes nær ved å slukkes; over den store bronselampe hever seg en blålig lysende krets.)
...
@stage (Lyskretsen oppløser seg; bordlampene brenner som før.)

@ {{{ 124 }}} Mystikeren Maximos *(ser opp)*.
Borte?
...
@ {{{ 129 }}} Fyrst Julian *(slår ut med hånden)*.
Den andre, Maximos!
...
{{{ 132 }}} Her frem, du tredje hjørnestein! Her frem, du tredje store frigivne under nødvendigheten!
...
@stage (Larm utenfor; danserinnene og fløytespillerne flykter.)
...
@stage (Kvestoren Leontes med et stort og praktfullt følge kommer inn fra høyre.)

@ Kvestoren Leontes.
Tilgi, jeg anroper deg hundre ganger, min nådigste herre –

@ {{{ 135 }}} Fyrst Julian *(et skritt tilbake)*.
Hva ser jeg!
...
@stage (En stor menneskesverm har imidlertid oppfylt forgården.)
...
@ Basilios fra Cæsaræa.
Deg var det bedre at du selv, med en møllestein om din hals, lå på havets bunn, enn at denne drøm skulle ligge bak deg. – Ser du {{{ 142 }}} ikke fristerens verk? All jordens herlighet legges for dine føtter.
...
@stage (Kvestoren Leontes ifører ham kåpen.)
...
@stage (Alle går ut gjennom forgården under mengdens bifallsrop; bare Gregor og Basilios blir stående.)
