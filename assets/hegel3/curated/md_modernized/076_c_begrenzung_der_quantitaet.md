...
## {{{ 154 }}} C. Begrenzung der Quantität
...
{{{ 155 }}} Oder die Größe ist zuerst unmittelbare Einheit der Kontinuität und Diskretion. Als Quantität ist sie ***die in sich zurückgekehrte*** Einheit dieser Momente; als diese ihre negative Einheit hat sie den in der unmittelbaren oder kontinuierlichen Größe nur verschwundenen oder nur möglichen Unterschied an ihr.
