...
Denn Eins ist Beziehung auf sich als negatives Beziehen; so ist es Fürsichsein überhaupt, ein Beziehen ohne {{{ 106 }}} Bezogenes. Aber insofern es Eins ist, ist es unmittelbar; und ist damit wesentlich Beziehung auf sich, als ***auf ein unmittelbares***; es ist damit ein ***Bezogenes*** vorhanden, aber durch absolut negative Beziehung, welche unendliches Aufheben des Andersseins ist. Das Eins geht also ***nicht in ein Anderes*** über; sondern ***es stößt sich*** selbst ***von sich ab***. Die negative Beziehung des Eins auf sich ist ***Repulsion***.
